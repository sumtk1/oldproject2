...
/**
 * Created by JinzLin on 2016/8/11.
 */
public class PictureUtlis {
     ...
     * @param height     缩放的高度
     */
    public static void loadImageViewHolderForOilPic(Context mContext, String path, ImageView mImageView,int width,int height) {
        Picasso.with(mContext).load(path).resize(width,height).centerInside().into(mImageView);
    }
