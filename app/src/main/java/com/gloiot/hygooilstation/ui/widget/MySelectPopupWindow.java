...
/**
 * Created by dlt on 2016/8/10.
 */
public class MySelectPopupWindow extends PopupWindow {
    ...
    public MySelectPopupWindow(Context context, View.OnClickListener itemsOnClick, List<String[]> datas) {
        super(context);
        mContext = context;
        ...
        iv_cancel = (LinearLayout) mMenuView.findViewById(R.id.ll_popupWindow_cancel);
        tv_select = (TextView) mMenuView.findViewById(R.id.tv_popupWindow_title);
        tv_confirm = (TextView) mMenuView.findViewById(R.id.tv_popupWindow_confirm);
        tv_explain = (TextView) mMenuView.findViewById(R.id.tv_popupWindow_explain);
...
//        rl_select.setOnClickListener(itemsOnClick);
        ...
        rl_add.setOnClickListener(itemsOnClick);//添加更多
     ...
     * 标题
     */
    public MySelectPopupWindow setTitle (String text){
     ...
     * 文本说明
     */
    public MySelectPopupWindow addExplain (String text){
     ...
     * 添加油卡
     */
    public MySelectPopupWindow addOilCard (){
     ...
     * @return
     */
    public MySelectPopupWindow setCustomView(int resId) {
     ...
     * @return
     */
    public ListView setListViewSingle(Context context) {
     ...
     * @return
     */
    public MySelectPopupWindow setMaxHeight(final View view) {
