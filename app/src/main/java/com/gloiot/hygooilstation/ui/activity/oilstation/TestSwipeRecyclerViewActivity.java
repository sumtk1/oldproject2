...
import com.gloiot.hygooilstation.ui.adapter.TestSwipeAdapter;
...
public class TestSwipeRecyclerViewActivity extends AppCompatActivity {

    private Activity mContext;

    private TestSwipeAdapter mMenuAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_swipe_recycler_view);
        ...
        mMenuAdapter = new TestSwipeAdapter(mStrings);
