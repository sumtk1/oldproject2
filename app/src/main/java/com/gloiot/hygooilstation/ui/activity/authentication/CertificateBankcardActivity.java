 ...
 * 资质认证--添加银行卡
 */
public class CertificateBankcardActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void requestSuccess(int requestTag, JSONObject response, int showLoad) throws JSONException {
        ...
        switch (requestTag) {
            ...
            case RequestAction.TAG_CERTIFICATEBANKCARD:
                startActivity(new Intent(this, com.gloiot.hygooilstation.ui.activity.authentication.SetPaypwdActivity.class));
                finish();
                break;
            default:
                break;
    ...
    private Boolean verification_certificationBankcard() {
        if (TextUtils.isEmpty(tv_certificateBankcard_selectbank.getText().toString())) {
            ...
            MyPromptDialogUtils.showPrompt(mContext, "请输入卡号");
            return false;
            ...
            MyPromptDialogUtils.showPrompt(mContext, "您输入的卡号有误");
            return false;
            ...
            return false;
        } else if (et_certificateBankcard_chikaName.getText().toString().length() > 10) {
            MyPromptDialogUtils.showPrompt(mContext, "您输入的姓名有误");
            return false;
