package com.gloiot.hygooilstation.ui.widget.pulltorefresh;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mEvents == 0) {
                    if (pullDownY > 0
                            || (((com.gloiot.hygooilstation.ui.widget.pulltorefresh.Pullable) pullableView).canPullDown()
                        ...
                        if (state == REFRESHING) {
                            ...
                            || (((com.gloiot.hygooilstation.ui.widget.pulltorefresh.Pullable) pullableView).canPullUp() && canPullUp && state != REFRESHING)) {
                        // 可以上拉，正在刷新时不能上拉
