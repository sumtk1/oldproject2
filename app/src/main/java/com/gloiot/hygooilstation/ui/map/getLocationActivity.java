 ...
 * 定位
 */
public class getLocationActivity extends AppCompatActivity implements LocationSource, AMapLocationListener {

    private Context mContext;
    private String country, province, city, district, street, streetNum;//高德地图返回信息
...
//                MToast.showToast(mContext, amapLocation.toString());
                Log.e("dingwei:", amapLocation.toString());
                ...
                if (isFirstLoc) {
                    //设置缩放级别
                    aMap.moveCamera(CameraUpdateFactory.zoomTo(19));//默认是设置17
                    //将地图移动到定位点
